...
Hi, this is my final project submission, to fit the theme of social good, I made an animal forum, where owners can help each other and discuss on how to properly care for their pets.

How to use the website: Just register for an account, and you would be able to create blogs/view other people's blogs. There's also a search page where you can try to search for relevant blogs.
